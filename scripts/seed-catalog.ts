...
const IMG_SETS: Record<string, string[]> = {
  ...
  office:      [pexelUrl(O1,800,1000), pexelUrl(O2,800,1000), pexelUrl(O1,600,800), pexelUrl(O2,600,800)],
  officeHover: [pexelUrl(O1,400,600),  pexelUrl(O2,400,600),  pexelUrl(O1,300,400), pexelUrl(O2,300,400)],
  occasion:      [pexelUrl(E1,800,1000), pexelUrl(E2,800,1000), pexelUrl(E1,600,800), pexelUrl(E2,600,800)],
  occasionHover:[pexelUrl(E1,400,600),  pexelUrl(E2,400,600),  pexelUrl(E1,300,400), pexelUrl(E2,300,400)],
  travel:      [pexelUrl(T1,800,1000), pexelUrl(T2,800,1000), pexelUrl(T1,600,800), pexelUrl(T2,600,800)],
  travelHover: [pexelUrl(T1,400,600),  pexelUrl(T2,400,600),  pexelUrl(T1,300,400), pexelUrl(T2,300,400)],
  ...
  evening:      [pexelUrl(E1,800,1000), pexelUrl(E2,800,1000), pexelUrl(E1,600,800), pexelUrl(E2,600,800)],
  eveningHover:[pexelUrl(E1,400,600),  pexelUrl(E2,400,600),  pexelUrl(E1,300,400), pexelUrl(E2,300,400)],
